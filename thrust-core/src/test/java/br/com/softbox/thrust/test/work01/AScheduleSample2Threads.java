...
public class AScheduleSample2Threads {
	...
	private static synchronized LocalWorkerThreadPool getASchedulerPool(String rootPath) {
		if (aSchedulerPool == null) {
			aSchedulerPool = new LocalWorkerThreadPool(1, 2, rootPath, new MyThrustWorkerBuilder());
		}
		return aSchedulerPool;
	}

	public AScheduleSample2Threads(String rootPath) {
